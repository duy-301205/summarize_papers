...
const Header = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 shrink-0 sticky top-0 z-10 font-display">
      ...
      <div className="flex items-center gap-3 md:gap-6 ml-3">
        ...
        <div
          ...
          className="flex items-center gap-3 pl-0 md:pl-2 cursor-pointer hover:opacity-80 transition-all group"
        >
